...
//gradient check listener is not finished. you also need to remove color combo box to make new Jbutton
public class paintApplication extends JPanel {//panel which we will draw on 

    private drawPanel myPanel;

    //paint application constructor 
    ...
    public class drawFrame extends JFrame {
        ...
        public class upperButtons extends JPanel {
            ...
            upperButtons() {
                ...
                //String ColorChoices[] = {"Black", "Blue", "Cyan", "Dark Gray", "Gray", "Green", "Light Gray", "Magenta", "Orange", "Pink", "Red", "White", "Yellow"};
                JComboBox ShapeSelection = new JComboBox(ShapeChoices);
                //JComboBox ColorSelection = new JComboBox(ColorChoices);
                ...
                //ColorSelectionHandler colorselectionhandler = new ColorSelectionHandler(ColorSelection);
                //ColorSelection.addActionListener(colorselectionhandler);
        ...
        public class lowerButtons extends JPanel {
            ...
            lowerButtons() {
                ...
                //taking take of first color button, creating, settinhg text, adding listener, adding to our lower panel 
                ...
                //taking care of secon color button
     ...
     public class DashCheckBoxHandler implements ActionListener {
            ...
            public void actionPerformed(ActionEvent event) {
                if (CheckBox.isSelected()) {
                  ...
                  //  myPanel.setStroke(new BasicStroke( myPanel.getWidth(), BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND, 10, myPanel.getDashLength(), 0 ));
                    
                } else if (!CheckBox.isSelected()) {
                    myPanel.setDash(false);
                 //   myPanel.setStroke(new BasicStroke( myPanel.getWidth(), BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND )); //non dashed line 
                }
        ...
        public class SecondColorButtonHandler implements ActionListener {
            ...
            //we need constructor to pass status of gradient checkbox 
    ...
    public class drawPanel extends JPanel {
        ...
        //drawPanel constructor to test what we've done so far
        ...
        //overriden method paintcomponent that draws shapes in array 
        @Override
        public void paintComponent(Graphics g) {
        ...
        //set methods for shapetype, current color, and filledshape
...
//shape class declarations
    public abstract class myShape {
        ...
        //no argument constructor that sets coordinates of shape to 0
        ...
        //Set Methods for individual coordinates and color
        void setX1(int myX1) {
            X1 = myX1;
        }
        ...
        //get methods for oval and rectangle 
        boolean getFill() {
            return ShapeFill;
        }
        ...
        //Get Methods for individual coordinates and color
        int getX1() {
            return X1;
        }
